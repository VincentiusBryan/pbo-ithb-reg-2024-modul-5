...
public class FormInputData {
    ...
    public void showForm(String action, KTP myKtp) {
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (Controller.checkInput(nikField, namaField, tempatLahirField, datePicker, genderGroup, bloodGroup, alamatField, RTField, RWField, kelDesaField, kecamatanField, agamaCB, statusNikahCB, karyawanSwastaCheck, pnsCheck, wiraswastaCheck, akademisiCheck, pengangguranCheck, groupKewarganegaraan, countryLabelField, photoFile, signatureFile, berlakuField, kotaPembuatanKTPField, datePickerKTP)) {
                    ...
                    StatusPerkawinan statusPerkawinan = Controller.getStatusPerkawinan(String.valueOf(statusNikahCB.getSelectedItem()));
                    ...
                    String kewarganegaraan = Controller.getCitizenship(groupKewarganegaraan.getSelection().getActionCommand(), wargaNegaraAsal);
                    ...
                    JFrame displayKTP = new JFrame("Form Input Data Penduduk"); 

                    displayKTP.setBounds(start_x, start_y, FRAME_WIDTH, FRAME_HEIGHT);
